"""Script to update Langinfra starter projects with the latest component versions."""

import asyncio
import os

import langinfra.main  # noqa: F401
...
async def main():
    ...
    Copies the code from langinfra/initial_setup/setup.py. Doesn't use the
