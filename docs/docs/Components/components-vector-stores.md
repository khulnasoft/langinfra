...
# Vector store components in Langinfra
...
Vector databases can be populated from within Langinfra with document ingestion pipelines, like the following
...
| Name                         | Type          | Description                                      |
|------------------------------|---------------|--------------------------------------------------|
| collection_name               | String        | The name of the Chroma collection. Default: "langinfra". |
...
| Name                      | Type          | Description                                      |
|---------------------------|---------------|--------------------------------------------------|
| index_name                 | String        | The name of the FAISS index. Default: "langinfra_index". |
| persist_directory          | String        | Path to save the FAISS index. It will be relative to where Langinfra is running. |
| search_query               | String        | The query to search for in the vector store.     |
