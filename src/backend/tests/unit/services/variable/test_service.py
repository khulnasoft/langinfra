...
import pytest
from langinfra.services.database.models.variable.model import VariableUpdate
...
async def test_initialize_user_variables__not_found_variable(service, session: AsyncSession):
    with patch("langinfra.services.variable.service.DatabaseVariableService.create_variable") as m:
