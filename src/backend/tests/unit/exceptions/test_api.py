...
def test_api_exception():
    from langinfra.exceptions.api import APIException, ExceptionBody
    ...
    with (
        patch(
            "langinfra.services.database.models.flow.utils.get_outdated_components",
            return_value=mock_outdated_components,
        ),
        patch("langinfra.api.utils.get_suggestion_message", return_value=mock_suggestion_message),
        patch(
            "langinfra.services.database.models.flow.utils.get_components_versions",
