...
def test_create_input_schema():
    from langinfra.io.schema import create_input_schema
...
class TestCreateInputSchema:
    ...
    def test_single_input_type_conversion(self):
        from langinfra.inputs.inputs import StrInput
        from langinfra.io.schema import create_input_schema
    ...
    def test_multiple_input_types(self):
        from langinfra.inputs.inputs import IntInput, StrInput
        from langinfra.io.schema import create_input_schema
    ...
    def test_non_standard_field_types_handling(self):
        from langinfra.inputs.inputs import FileInput
        from langinfra.io.schema import create_input_schema
    ...
    def test_complex_nested_structures_handling(self):
        from langinfra.inputs.inputs import NestedDictInput
        from langinfra.io.schema import create_input_schema
    ...
    def test_field_types_conversion(self):
        from langinfra.inputs.inputs import IntInput
        from langinfra.io.schema import create_input_schema
