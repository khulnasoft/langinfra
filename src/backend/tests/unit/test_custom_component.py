...
from langinfra.custom import Component, CustomComponent
from langinfra.custom.code_parser.code_parser import CodeParser, CodeSyntaxError
from langinfra.custom.custom_component.base_component import BaseComponent, ComponentCodeNullError
...
from langinfra.field_typing import BaseLanguageModel
...
def test_code_parser_parse_classes():
    ...
    parser = CodeParser("from langinfra.custom import Component\n\nclass Test(Component): pass")
    tree = parser.get_tree()
    for node in ast.walk(tree):
