...
from langinfra.helpers import docs_to_data
from langinfra.inputs import DictInput, FloatInput, MessageTextInput, NestedDictInput
from langinfra.io import (
    BoolInput,
    DataInput,
    DropdownInput,
    HandleInput,
...
class AstraDBVectorStoreComponent(LCVectorStoreComponent):
    ...
    documentation: str = "https://docs-langinfra.khulnasoft.com/starter-projects-vector-store-rag"
    name = "AstraDB"
    icon: str = "AstraDB"
    ...
    inputs = [
        ...
        StrInput(
            ...
            advanced=os.getenv("LANGINFRA_HOST") is not None,
            required=os.getenv("LANGINFRA_HOST") is None,
        ),
        StrInput(
            name="keyspace",
    ...
    def build_vector_store(self, vectorize_options=None):
        ...
        # Get the running environment for Langinfra
        environment = (
        ...
        # Get Langinfra version and platform information
        __version__ = get_version_info()["version"]
        langinfra_prefix = ""
        if os.getenv("LANGINFRA_HOST") is not None:
            langinfra_prefix = "ds-"
        ...
        try:
            vector_store = AstraDBVectorStore(
                ...
                ext_callers=[(f"{langinfra_prefix}langinfra", __version__)],
