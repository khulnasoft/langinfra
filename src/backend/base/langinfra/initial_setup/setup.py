...
from langinfra.base.constants import FIELD_FORMAT_ATTRIBUTES, NODE_FORMAT_ATTRIBUTES, ORJSON_OPTIONS
from langinfra.initial_setup.constants import STARTER_FOLDER_DESCRIPTION, STARTER_FOLDER_NAME
...
from langinfra.services.database.models.folder.model import Folder, FolderCreate
from langinfra.services.database.models.folder.utils import (
    create_default_folder_if_it_doesnt_exist,
    get_default_folder_id,
)
from langinfra.services.database.models.user.crud import get_user_by_username
from langinfra.services.deps import (
    async_session_scope,
    get_settings_service,
    get_storage_service,
    get_variable_service,
)
from langinfra.template.field.prompt import DEFAULT_PROMPT_INTUT_TYPES
from langinfra.utils.util import escape_json_dump
...
async def load_flows_from_directory() -> None:
    """On langinfra startup, this loads all flows from the directory specified in the settings.
...
async def create_or_update_starter_projects(all_types_dict: dict, *, do_create: bool = True) -> None:
    ...
    async with async_session_scope() as session:
        ...
        for project_path, project in starter_projects:
            ...
            do_update_starter_projects = os.environ.get("LANGINFRA_UPDATE_STARTER_PROJECTS", "true").lower() == "true"
