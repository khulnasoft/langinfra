...
from langinfra.events.event_manager import EventManager, create_default_event_manager
...
from langinfra.schema.message import ErrorMessage
...
from langinfra.services.deps import get_chat_service, get_session, get_telemetry_service, session_scope
from langinfra.services.telemetry.schema import ComponentPayload, PlaygroundPayload

if TYPE_CHECKING:
    from langinfra.graph.vertex.types import InterfaceVertex
...
async def try_running_celery_task(vertex, user_id):
    ...
    try:
        from langinfra.worker import build_vertex
