...
from langinfra.services.database.models.message.model import MessageBase
...
class MessageTextInput(StrInput, MetadataTraceMixin, InputTraceMixin, ToolModeMixin):
    """Represents a text input component for the Langinfra system.

    This component is used to handle text inputs in the Langinfra system.
