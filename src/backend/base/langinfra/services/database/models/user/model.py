...
from langinfra.schema.serialize import UUIDstr

if TYPE_CHECKING:
    from langinfra.services.database.models.api_key import ApiKey
    from langinfra.services.database.models.flow import Flow
    from langinfra.services.database.models.folder import Folder
    from langinfra.services.database.models.variable import Variable
