# Path: src/backend/langinfra/services/database/models/flow/model.py
...
if TYPE_CHECKING:
    from langinfra.services.database.models import TransactionTable
    from langinfra.services.database.models.folder import Folder
    from langinfra.services.database.models.message import MessageTable
