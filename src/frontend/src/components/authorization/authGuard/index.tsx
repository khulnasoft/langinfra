import {
  LANGINFRA_ACCESS_TOKEN_EXPIRE_SECONDS,
  LANGINFRA_ACCESS_TOKEN_EXPIRE_SECONDS_ENV,
...
export const ProtectedRoute = ({ children }) => {
  ...
  useEffect(() => {
    const envRefreshTime = LANGINFRA_ACCESS_TOKEN_EXPIRE_SECONDS_ENV;
    const automaticRefreshTime = LANGINFRA_ACCESS_TOKEN_EXPIRE_SECONDS;
