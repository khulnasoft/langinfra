      ...
      <div className={`flex items-center gap-2`}>
        ...
        >
          {ENABLE_DATASTAX_LANGINFRA ? (
            ...
            <LanginfraLogo className="h-5 w-6" />
          ) : (
        ...
        {!ENABLE_DATASTAX_LANGINFRA && (
          <>
            <Button
              ...
              onClick={() =>
                window.open("https://github.com/khulnasoft/langinfra", "_blank")
              }
            >
              <GithubStarComponent />
            </Button>
          ...
          <>
            <ShadTooltip content="Docs" side="bottom" styleClasses="z-10">
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://docs.datastax.com/en/langinfra/index.html",
                    "_blank",
                  )
                }
              >
