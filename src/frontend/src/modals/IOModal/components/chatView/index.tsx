  ...
  return (
    ...
    >
      <div className="eraser-size">
        <div ref={messagesRef} className="chat-message-div">
          {chatHistory?.length > 0 ? (
            ...
            <div className="chat-alert-box">
              <span>
                👋 <span className="langinfra-chat-span">Langinfra Chat</span>
              </span>
              <br />
              <div className="langinfra-chat-desc">
                <span className="langinfra-chat-desc-span">
                  {CHAT_FIRST_INITIAL_TEXT}{" "}
                  <span>
                    <IconComponent
        ...
        <div className="langinfra-chat-input-div">
          <div className="langinfra-chat-input">
            <ChatInput
              chatValue={chatValue}
