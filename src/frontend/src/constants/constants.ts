...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the Langinfra documentation for more information on how to write your own component.";
...
export const DESCRIPTIONS: string[] = [
  ...
  "Langinfra: Create, Chain, Communicate.",
  ...
  "Design Dialogues with Langinfra.",
...
export const LANGINFRA_SUPPORTED_TYPES = new Set([
  "str",
  "bool",
  "float",
  "code",
...
export const LANGINFRA_CHAT_TITLE = "Langinfra Chat";
...
export const STORE_TITLE = "Langinfra Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your Langinfra API key.";
...
export const LANGINFRA_ACCESS_TOKEN = "access_token_lf";
export const LANGINFRA_API_TOKEN = "apikey_tkn_lflw";
export const LANGINFRA_AUTO_LOGIN_OPTION = "auto_login_lf";
export const LANGINFRA_REFRESH_TOKEN = "refresh_token_lf";

export const LANGINFRA_ACCESS_TOKEN_EXPIRE_SECONDS = 60 * 60 - 60 * 60 * 0.1;
export const LANGINFRA_ACCESS_TOKEN_EXPIRE_SECONDS_ENV =
