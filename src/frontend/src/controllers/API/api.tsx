  ...
  useEffect(() => {
    const unregister = fetchIntercept.register({
      request: function (url, config) {
        const accessToken = cookies.get(LANGINFRA_ACCESS_TOKEN);
    ...
    const isAuthorizedURL = (url) => {
      const authorizedDomains = [
        "https://raw.githubusercontent.com/khulnasoft/langinfra_examples/main/examples",
        "https://api.github.com/repos/khulnasoft/langinfra_examples/contents/examples",
        "https://api.github.com/repos/khulnasoft/langinfra",
        "auto_login",
      ];
