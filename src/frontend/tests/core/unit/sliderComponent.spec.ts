...
test(
  ...
  async ({ page }) => {
    ...
    cleanCode = cleanCode.replace(
      "from langinfra.io import BoolInput, DictInput, DropdownInput, FloatInput, IntInput, StrInput",
      "from langinfra.io import BoolInput, DictInput, DropdownInput, FloatInput, IntInput, StrInput, SliderInput",
    );
